...
var InputPopup = (function (_Component) {
  ...
  function InputPopup(props) {
    ...
    _classCallCheck(this, _InputPopup);

    _get(Object.getPrototypeOf(_InputPopup.prototype), 'constructor', this).call(this, props);
  ...
  var _InputPopup = InputPopup;
  InputPopup = _wrapComponent('_$InputPopup')(InputPopup) || InputPopup;
  return InputPopup;
})(_react.Component);
